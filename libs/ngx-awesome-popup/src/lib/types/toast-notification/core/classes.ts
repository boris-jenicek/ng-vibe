...
export class ToastNotificationInitializer {
  private toastNotificationCarrier: ToastNotificationCarrier =
    new ToastNotificationCarrier();
...
export class ToastNotificationeventsController {
  ...
  private readonly _afterClosed: Subject<IPrivateResponseMerged> =
    new Subject<IPrivateResponseMerged>();
...
export class ToastNotificationCarrier {
  toastNotificationBelonging: ToastNotificationBelonging =
    new ToastNotificationBelonging();
  ...
  implements IToastNotificationBelonging
{
  ...
  constructor() {
    ...
    this.buttons =
      toastNotificationConfigurator.productionConfig.buttons.slice();
  }
}
