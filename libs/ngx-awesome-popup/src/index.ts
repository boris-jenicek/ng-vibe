import {
  ...
  IDispatch,
  IGlobalUserConfig,
} from './lib/core/global-interfaces';
import { ConfirmBoxInitializer } from './lib/types/confirm-box/core/classes';
import {
  IConfirmBoxCoreConfig,
  IConfirmBoxPublicResponse,
  IConfirmBoxUserConfig,
} from './lib/types/confirm-box/core/interfaces';
import {
  DialogBelonging,
  DialogInitializer,
} from './lib/types/dialog/core/classes';
import {
  IDialogCoreConfig,
  IDialogeventsController,
  IDialogPublicResponse,
  IDialogUserConfig,
} from './lib/types/dialog/core/interfaces';
import {
  ResetToastGlobalSettings,
  ToastNotificationInitializer,
} from './lib/types/toast-notification/core/classes';
import {
  IGlobalToastSettings,
  IToastCoreConfig,
  IToastNotificationPublicResponse,
  IToastNotificationUserConfig,
} from './lib/types/toast-notification/core/interfaces';
...
export { ButtonLayoutDisplay } from './lib/core/enums';
export { DialogLayoutDisplay } from './lib/core/enums';
export { VerticalPosition } from './lib/core/enums';
export { ToastPositionEnum } from './lib/types/toast-notification/core/enums';
export { ToastProgressBarEnum } from './lib/types/toast-notification/core/enums';
export { ToastUserViewTypeEnum } from './lib/types/toast-notification/core/enums';
/**
 *
 * ## Choose between many appearing animations that are available
 */
export { AppearanceAnimation } from './lib/core/enums';
/**
 *
 * ## Choose between many disappearing animations that are available
 */
export { DisappearanceAnimation } from './lib/core/enums';
/**
 * @returns It will return custom button object ready to be used in child component layout.
 */
export { ButtonMaker } from './lib/core/global-classes';
 ...
 * ```
 */
export { ResetGlobalConfig } from './lib/core/global-config.service';
 ...
 */
export { NgxAwesomePopupModule } from './lib/ngx-awesome-popup.module';
/**
 ...
 * @category Imports for angular app.module
 */
export { DialogConfigModule } from './lib/ngx-awesome-popup.module';
/**
 ...
 * @category Imports for angular app.module
 */
export { ConfirmBoxConfigModule } from './lib/ngx-awesome-popup.module';
/**
 ...
 * @category Imports for angular app.module
 */
export { ToastNotificationConfigModule } from './lib/ngx-awesome-popup.module';
// endregion
 ...
 * ```
 */
export { ConfirmBoxEvokeService } from './lib/types/confirm-box/core/confirm-box-evoke.service';
/**
 * Global styles set in app.module.ts will affect the instance. See <a href="https://costlydeveloper.github.io/ngx-awesome-popup/#/documentation/class-ToastEvokeService">Global Config</a> setup.
 *```typescript
 * // Inject this service as Dependency Injection in a constructor like example below,
 ...
 * ```
 */
export { ToastEvokeService } from './lib/types/toast-notification/core/toast-evoke.service';
